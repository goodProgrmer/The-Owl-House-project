...
def main():
    ...
    buttons.append(button(lambda: print("unabled"),(500,20,200,75),(255,0,0),"two player", image= pygame.image.load("images/system image/gray button.png"), onpose_img= None))
